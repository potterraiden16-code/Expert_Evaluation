...
st.markdown("""
    <style>
    /* 1. 彻底隐藏右侧所有官方图标 (Share, Star, Edit, GitHub) */
    [data-testid="stHeaderActionElements"], 
    .st-emotion-cache-1px9707, 
    .stAppDeployButton,
    header [data-testid="stToolbar"] {
        display: none !important;
    }

    /* 2. 移除头部背景、阴影和装饰线，使其完全透明且不占位 */
...
if current_doc_id:
    ...
    with tab_score:
        with st.form("delphi_full_form"):
            ...
            st.markdown('<div class="anchor-box">9-10卓越(NSC级); 7-8.9优秀(教授); 5-6.9合格(博士); 3-4.9欠佳; 1-2.9不合格</div>', unsafe_allow_html=True)
